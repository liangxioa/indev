...
def getOne(sql, data):
    mysql = Mysql()  # 申请资源
    result = mysql.getOne(sql, data)
    mysql.dispose()  # 释放资源
    return result


def getMany(sql, data):
    mysql = Mysql()  # 申请资源
    result = mysql.getMany(sql, data)
    mysql.dispose()  # 释放资源
    return result


def insertOne(sql, data):
    mysql = Mysql()  # 申请资源
...
def insertMany(sql, data):
    mysql = Mysql()  # 申请资源
    result = mysql.insertMany(sql, data)
    mysql.dispose()  # 释放资源
    return result
